...
# define RT_MDL_TYPE      RT_MODEL_massSpringDamper3_T
#endif
#define QUOTE1(name) #name
#define QUOTE(name) QUOTE1(name)    /* need to expand name    */
#ifndef FMI2_FUNCTION_PREFIX
#define FMI2_FUNCTION_PREFIX massSpringDamper3_
#endif
/*==========*
 * Includes *
 *==========*/
...
fmi2Component fmi2Instantiate(fmi2String instanceName, fmi2Type fmuType, fmi2String fmuGUID,
    ...
    if (!functions->logger) {
        ...
        return NULL;
    } else if (strcmp(fmuGUID, "{78477140-9cc7-345b-a0c4-b6827231bc68}")) {
        functions->logger(functions->componentEnvironment, instanceName, fmi2Error, "error",
                "fmi2Instantiate: Wrong GUID %s. Expected %s.", fmuGUID, "{78477140-9cc7-345b-a0c4-b6827231bc68}");
        return NULL;
    }
    ...
    modelData->S = massSpringDamper3_M;
    if (modelData->S == NULL) {
        functions->logger(functions->componentEnvironment, instanceName, fmi2Error, "error",
    ...
    modelData->rList = (real_T**)calloc(6, sizeof(real_T*));
    if (!modelData->rList) {
        functions->logger(functions->componentEnvironment, instanceName, fmi2Error, "error",
                "fmi2Instantiate: Memory allocation error.");
        return NULL;
    ...
    modelData->rList[0] = &(massSpringDamper3_U.Input);
    modelData->rList[1] = &(massSpringDamper3_Y.Output);
    modelData->rList[2] = &(modelData->time);
    modelData->rList[3] = &(massSpringDamper3_P.b);
    modelData->rList[4] = &(massSpringDamper3_P.k);
    modelData->rList[5] = &(massSpringDamper3_P.m);
    fmu_syncToBuffer();
