...
# define RT_MDL_TYPE      RT_MODEL_MSD_11_21_23_T
#endif
#define QUOTE1(name) #name
#define QUOTE(name) QUOTE1(name)    /* need to expand name    */
#ifndef FMI2_FUNCTION_PREFIX
#define FMI2_FUNCTION_PREFIX MSD_11_21_23_
#endif
/*==========*
 * Includes *
 *==========*/
...
fmi2Component fmi2Instantiate(fmi2String instanceName, fmi2Type fmuType, fmi2String fmuGUID,
    ...
    if (!functions->logger) {
        ...
        return NULL;
    } else if (strcmp(fmuGUID, "{f10ac9fc-33d1-d05b-1627-9c0ee177efd2}")) {
        functions->logger(functions->componentEnvironment, instanceName, fmi2Error, "error",
                "fmi2Instantiate: Wrong GUID %s. Expected %s.", fmuGUID, "{f10ac9fc-33d1-d05b-1627-9c0ee177efd2}");
        return NULL;
    }
    ...
    modelData->rList[0] = &(MSD_11_21_23_U.Input);
    modelData->rList[1] = &(MSD_11_21_23_Y.Output);
    modelData->rList[2] = &(modelData->time);
    modelData->rList[3] = &(MSD_11_21_23_P.b);
    modelData->rList[4] = &(MSD_11_21_23_P.k);
    modelData->rList[5] = &(MSD_11_21_23_P.m);
    fmu_syncToBuffer();
