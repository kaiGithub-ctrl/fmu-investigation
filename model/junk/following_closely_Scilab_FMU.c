...
**    Date : 13-Dec-2023
**    Author : Kai
**    Model description : i followed so closely pls
**    Model version : 0.1
*/
...
#define MODEL_IDENTIFIER following_closely
...
typedef struct {
   ...
   fmiInteger *integer;
   fmiBoolean *boolean;
   scicos_block block_following_closely[6];
   fmiBoolean internalEvent[1];
} fmuInstance;

/* ---- Internals functions declaration ---- */
static fmiStatus following_closely_sciOutputCompute(fmuInstance *, int);
...
static void **following_closely_block_outtbptr;
static void **work;
...
static fmiStatus following_closely_sciOutputCompute(fmuInstance *newInstance, int flag) {
    int nevprt = 1;
