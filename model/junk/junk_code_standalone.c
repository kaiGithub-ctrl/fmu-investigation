...
int junk_code_sim(double, double, double, int);

void junk_code_sensor(int *, int *, int *, double *,void *, int *,
   int *,int *, int);

void junk_code_actuator(int *, int *, int *, double *, void *, int *,
   int *,int *,int);
...
/* Code prototype for standalone use  */
int C2F(junk_codesimblk)(double , double *, double *);
...
scicos_block block_junk_code[6];
...
int junk_code_sim(tf,dt,h,solver)
   ...
   int solver;
{
  ...
  */
  ...
  junk_code_block_outtbptr = (void **)(z+0);

  junk_code_block_outtbptr[0] = (void *) outtb_1;
  junk_code_block_outtbptr[1] = (void *) outtb_2;
  junk_code_block_outtbptr[2] = (void *) outtb_3;
  junk_code_block_outtbptr[3] = (void *) outtb_4;
  ...
  if ((block_junk_code[0].inptr  = malloc(sizeof(double*)*block_junk_code[0].nin))== NULL) return 0;
  ...
  if ((block_junk_code[0].outptr = malloc(sizeof(double*)*block_junk_code[0].nout))== NULL) return 0;
  ...
  if ((block_junk_code[1].inptr  = malloc(sizeof(double*)*block_junk_code[1].nin))== NULL) return 0;
  ...
  if ((block_junk_code[1].outptr = malloc(sizeof(double*)*block_junk_code[1].nout))== NULL) return 0;
  ...
  if ((block_junk_code[2].inptr  = malloc(sizeof(double*)*block_junk_code[2].nin))== NULL) return 0;
  ...
  if ((block_junk_code[2].outptr = malloc(sizeof(double*)*block_junk_code[2].nout))== NULL) return 0;
  ...
  if ((block_junk_code[3].inptr  = malloc(sizeof(double*)*block_junk_code[3].nin))== NULL) return 0;
  ...
  if ((block_junk_code[3].outptr = malloc(sizeof(double*)*block_junk_code[3].nout))== NULL) return 0;
  ...
  block_junk_code[3].ipar=&(IPAR1[2]);
  ...
  if ((block_junk_code[4].inptr  = malloc(sizeof(double*)*block_junk_code[4].nin))== NULL) return 0;
  ...
  if ((block_junk_code[4].outptr = malloc(sizeof(double*)*block_junk_code[4].nout))== NULL) return 0;
  ...
  if ((block_junk_code[5].inptr  = malloc(sizeof(double*)*block_junk_code[5].nin))== NULL) return 0;
  ...
  if ((block_junk_code[5].outptr = malloc(sizeof(double*)*block_junk_code[5].nout))== NULL) return 0;
  ...
  while (t < tf) {
    ...
    */
    while (tout+h<t+dt){
      switch (solver) {
      case 1:
        ode1(C2F(junk_codesimblk),tout,h);
        break;
      case 2:
        ode2(C2F(junk_codesimblk),tout,h);
        break;
      case 3:
        ode4(C2F(junk_codesimblk),tout,h);
        break;
      default :
        ode4(C2F(junk_codesimblk),tout,h);
        break;
    ...
    switch (solver) {
    case 1:
      ode1(C2F(junk_codesimblk),tout,he);
      break;
    case 2:
      ode2(C2F(junk_codesimblk),tout,he);
      break;
    case 3:
      ode4(C2F(junk_codesimblk),tout,he);
      break;
    default :
      ode4(C2F(junk_codesimblk),tout,he);
      break;
...
int C2F(junk_codesimblk)(t, x, xd)
