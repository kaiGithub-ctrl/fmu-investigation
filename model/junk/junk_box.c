...
int  junk_box(scicos_block *block, int flag)
{
  ...
  scicos_block *block_junk_box;

  /*  work of blocks are catenated at the end of z */
  work = (void **)(z+0);

  /*  junk_box_block_outtbptr is catenated at the end of oz */
  junk_box_block_outtbptr = (void **)(ozptr+0);

  /* struct of all blocks are stored in work of that block struct */
  block_junk_box=(scicos_block*) *block->work;

  /* Copy inputs in the block outtb */
  memcpy(*(junk_box_block_outtbptr+0),*(u+0),1*sizeof(double));
  ...
  if (flag != 4 && flag != 6 && flag != 5){
    ...
    if (*reentryflag==0){
      *reentryflag=1;
      ...
      block_junk_box[0].x         = &(zero);
      block_junk_box[0].xd        = w;
      block_junk_box[0].g         = &(zero);
      ...
      block_junk_box[1].x         = &(zero);
      block_junk_box[1].xd        = w;
      block_junk_box[1].g         = &(zero);
      ...
      block_junk_box[2].x         = &(zero);
      block_junk_box[2].xd        = w;
      block_junk_box[2].g         = &(g[0]);
      block_junk_box[2].mode      = &(mode[0]);
      ...
      block_junk_box[3].x         = &(zero);
      block_junk_box[3].xd        = w;
      block_junk_box[3].g         = &(zero);
      block_junk_box[3].ipar      = &(ipar[2]);
      ...
      block_junk_box[5].x         = &(zero);
      block_junk_box[5].xd        = w;
      block_junk_box[5].g         = &(zero);
  ...
  if (flag == 0) { /* Continuous state computation */
    ...
    *reentryflag=0;
    ...
    if ((block_junk_box[0].inptr  = malloc(sizeof(void *)*block_junk_box[0].nin))== NULL) return 0;
    if ((block_junk_box[0].outsz  = malloc(3*sizeof(int)*block_junk_box[0].nout))== NULL) return 0;
    if ((block_junk_box[0].outptr = malloc(sizeof(void*)*block_junk_box[0].nout))== NULL) return 0;
    block_junk_box[0].outptr[0] = junk_box_block_outtbptr[0];
    ...
    if ((block_junk_box[1].inptr  = malloc(sizeof(void *)*block_junk_box[1].nin))== NULL) return 0;
    block_junk_box[1].inptr[0]  = junk_box_block_outtbptr[1];
    ...
    if ((block_junk_box[1].outptr = malloc(sizeof(void*)*block_junk_box[1].nout))== NULL) return 0;
    block_junk_box[1].z         = &(z[0]);
    block_junk_box[1].work      = (void **)(((double *)work)+1);
    block_junk_box[1].nevprt    = nevprt;

    /* set blk struc. of 'absolute_value' (type 4 - blk nb 3 - uid ) */
    block_junk_box[2].type   = 4;
    block_junk_box[2].ztyp   = 1;
    block_junk_box[2].ng     = 1;
    block_junk_box[2].nx     = 0;
    block_junk_box[2].x      = &(zero);
    block_junk_box[2].xd     = w;
    block_junk_box[2].g      = &(g[0]);
    block_junk_box[2].mode   = &(mode[0]);
    ...
    if ((block_junk_box[2].inptr  = malloc(sizeof(void *)*block_junk_box[2].nin))== NULL) return 0;
    block_junk_box[2].inptr[0]  = junk_box_block_outtbptr[0];
    ...
    if ((block_junk_box[2].outptr = malloc(sizeof(void*)*block_junk_box[2].nout))== NULL) return 0;
    block_junk_box[2].outptr[0] = junk_box_block_outtbptr[2];
    ...
    if ((block_junk_box[3].inptr  = malloc(sizeof(void *)*block_junk_box[3].nin))== NULL) return 0;
    block_junk_box[3].inptr[0]  = junk_box_block_outtbptr[0];
    block_junk_box[3].inptr[1]  = junk_box_block_outtbptr[2];
    ...
    if ((block_junk_box[3].outptr = malloc(sizeof(void*)*block_junk_box[3].nout))== NULL) return 0;
    block_junk_box[3].outptr[0] = junk_box_block_outtbptr[1];
    ...
    block_junk_box[3].ipar      = &(ipar[2]);
    block_junk_box[3].work      = (void **)(((double *)work)+3);
    block_junk_box[3].nevprt    = nevprt;
    ...
    if ((block_junk_box[4].inptr  = malloc(sizeof(void *)*block_junk_box[4].nin))== NULL) return 0;
    block_junk_box[4].inptr[0]  = junk_box_block_outtbptr[0];
    ...
    if ((block_junk_box[4].outptr = malloc(sizeof(void*)*block_junk_box[4].nout))== NULL) return 0;
    block_junk_box[4].outptr[0] = junk_box_block_outtbptr[3];
    ...
    if ((block_junk_box[5].inptr  = malloc(sizeof(void *)*block_junk_box[5].nin))== NULL) return 0;
    block_junk_box[5].inptr[0]  = junk_box_block_outtbptr[3];
    ...
    if ((block_junk_box[5].outptr = malloc(sizeof(void*)*block_junk_box[5].nout))== NULL) return 0;
    block_junk_box[5].z         = &(z[0]);
    block_junk_box[5].work      = (void **)(((double *)work)+5);
    block_junk_box[5].nevprt    = nevprt;
    ...
    for (kf = 0; kf < 6; ++kf) {
      if (block_junk_box[kf].insz!=NULL) {
        free(block_junk_box[kf].insz);
      }else {
        break;
      }
      if (block_junk_box[kf].outsz!=NULL){
        free(block_junk_box[kf].outsz);
      }else {
        break;
      }
      if (block_junk_box[kf].nopar!=0){
        if (block_junk_box[kf].oparptr!=NULL){
          free(block_junk_box[kf].oparptr);
        }else {
          break;
        }
        if (block_junk_box[kf].oparsz!=NULL){
          free(block_junk_box[kf].oparsz);
        }else {
          break;
        }
        if (block_junk_box[kf].opartyp!=NULL){
          free(block_junk_box[kf].opartyp);
        }else {
          break;
        }
      }
      if (block_junk_box[kf].noz!=0){
        if (block_junk_box[kf].ozptr!=NULL){
          free(block_junk_box[kf].ozptr);
        }else {
          break;
        }
        if (block_junk_box[kf].ozsz!=NULL){
          free(block_junk_box[kf].ozsz);
        }else {
          break;
        }
        if (block_junk_box[kf].oztyp!=NULL){
          free(block_junk_box[kf].oztyp);
        }else {
          break;
        }
      }
      if (block_junk_box[kf].evout!=NULL){
        free(block_junk_box[kf].evout);
      }else {
        break;
      }
    }
    scicos_free(block_junk_box);
  }

  memcpy(*(y+0),*(junk_box_block_outtbptr+1),2*sizeof(double));
  memcpy(*(y+1),*(junk_box_block_outtbptr+3),1*sizeof(double));
  return 0;
