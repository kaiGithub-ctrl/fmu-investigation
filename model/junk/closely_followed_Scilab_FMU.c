...
**    Date : 13-Dec-2023
**    Author : k
**    Model description : why isnt this working
**    Model version : 0.1
*/
...
#define MODEL_IDENTIFIER closely_followed
...
typedef struct {
   ...
   fmiInteger *integer;
   fmiBoolean *boolean;
   scicos_block block_closely_followed[6];
   fmiBoolean internalEvent[1];
} fmuInstance;

/* ---- Internals functions declaration ---- */
static fmiStatus closely_followed_sciOutputCompute(fmuInstance *, int);
...
static void **closely_followed_block_outtbptr;
static void **work;
...
static fmiStatus closely_followed_sciOutputCompute(fmuInstance *newInstance, int flag) {
    int nevprt = 1;
