...
/*---------------------------------------- Actuators */
void junk_box_actuator(int *flag, int *nport, int *nevprt, double *t, void *u, int *nu1, int *nu2, int *ut, int flag1)
     /*
      ...
      */
{
  ...
  break;
    ...
    fprintf(fprw,"%f " \
                 ...
                 "%f \n", \
                 *t,
                 *(((double *)(junk_box_block_outtbptr+1))+0), *(((double *)(junk_box_block_outtbptr+1))+1),
                 *(((double *)(junk_box_block_outtbptr+3))+0));
    }
...
/*---------------------------------------- Sensor */
void junk_box_sensor(int *flag, int *nport, int *nevprt, double *t, void *y, int *ny1, int *ny2, int *yt, int *flag1)
     /*
      * To be customized for standalone execution
      * flag  : specifies the action to be done
      * nport : specifies the  index of the Super Bloc
      ...
      */
{
  ...
  if (flag1 == 0) {
    ...
    fscanf(fprr,"%lf " \
                "%lf \n", \
                &temps,
                (double *)(junk_box_block_outtbptr+0)+0);
    }
    else if (*flag == 5 && *nport == 1) {
      fclose(fprr);
    }
